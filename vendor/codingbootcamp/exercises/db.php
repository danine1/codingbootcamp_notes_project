...
//FQN (Fully Qualified Name): codingbootcamp\exercises\db - just means that there can 
//be another file called 
class db 
{
    ...
    *
    * if the connection has been made, it will just return
    * the object, if not, it will first connect
    * and then return it
    *
    ...
    */
    ...
    public static function pdo()
    {
        ...
        return static::$pdo; // after condition end no matter if it runs or not
